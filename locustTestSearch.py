...
class UserFS(HttpUser): 
    # host = 'https://10.20.20.246:443/api'
   # host = 'https://stage-service-api.fstravel.com/'
    ...
    def searchTurkey(self):
        ...
        url = f"/api/service-api/f-s/get-by-country?departureCityId=274286&arrivalCountryId=18803&minStartDate=2024-07-11&maxStartDate=2024-07-11&minNightsCount={min_nights_count}&maxNightsCount={max_nights_count}&adults=2&flightTypes=all&sort=recommendations_FS"
