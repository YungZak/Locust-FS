...
class UserFS(HttpUser): 
    ...
    @task(1) 
    def getArrival2(self):

        # TOKEN = "f876b87654ec42c18e227161391a114a"
        TOKEN = "37ee989c5cc347269ce64073424cdc7a"
        headers = {
        ...
        self.client.get(url, headers=headers, name="HOTELS=781487%2C355421")
    
    @task(1) 
    def getArrival1(self):
        ...
        self.client.get(url, headers=headers, name="HOTELS=30691")

    @task(1) 
    def getArrival4(self):
        ...
        self.client.get(url, headers=headers, name="HOTELS=584040")

    @task(1) 
    def getArrival5(self):
        ...
        self.client.get(url, headers=headers, name="HOTELS=703276")
